...
Basically, similarity measures are computed between matching variables accross two records. These similarity measures are then combined to an overal measure.
